...
- **Wikipedia description** (`wikimedia.py`, E5, 23 Sept 2026): with no typed description and a
  LEI from GLEIF, the gatherer asks Wikidata for the item whose P1278 is the LEI, then the
